...
page.onCallback = function (json) {
    ...
    /******* Photos part *******/
        ...
        moveToNextSection("photos");
    } else if (json.method == "photos_end") {
        moveToNextSection("photos");
    }
    ...
    /******* Reviews part *******/
        ...
        steps.push(common.multiBizRedirect(yelpObject.account.biz_id));
        steps.push(function () {
            page.evaluate(function () {
