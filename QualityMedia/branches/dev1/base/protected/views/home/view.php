                ...
                <div class="container">
                        ...
                        <div class="col-md-12 col-sm-12">
                             <div class="clients-block">
                                <div class="container" style="overflow: hidden">
                                    <ul id="scroller">
                                        <li><img width="2706" src="<?php echo $this->resourceUrl('images_v2/img-client.png', 's3'); ?>" alt="" /></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row featured">
                        <div class="col-md-4 center">
                            <div class="img">
                                <?php echo CHtml::image($this->resourceUrl('images_v2/bloomberg.png', 's3'), ''); ?>
                            </div>
                        ...
                        <div class="col-md-4 center">
                            <div class="img">
                                <?php echo CHtml::image($this->resourceUrl('images_v2/marketwatch.png', 's3'), ''); ?>
                            </div>
                    ...
                    <div class="row about-box">
                        <div class="img-auto">
                            <?php echo CHtml::image($this->resourceUrl('images_v2/about-img2.jpg', 's3'), ''); ?>
                        </div>
                        <div class="col-sm-6 new-about-text">
                            <div class="text-center">
                            <?php echo CHtml::image($this->resourceUrl('images_v2/hand2-img.png', 's3'), ''); ?>
                            </div>
                            <h3>IT'S NOT ABOUT WHERE YOU ARE. BUT WHERE YOU ARE GOING</h3>
                            <h5>ARE YOU INSPIRED? DOES YOUR BUSINESS MAKE A DIFFERENCE? ARE YOU LOOKING TO CONNECT WITH YOUR CUSTOMERS AT A HIGHER LEVEL? TO US, RELATIONSHIPS ARE THE HEARTBEAT AT QUALITY MEDIA.  WE BUILD LASTING RELATIONSHIPS AND PARTNER WITH COMPANIES WHO SHARE THIS PASSION WITH THEIR CUSTOMERS.</h5>
                            <h5 style="text-align: center; font-size: 25px; padding-top: 10px">WHAT DRIVES YOU?</h5>
                        </div>
                    ...
                    <br /><br />
                    <?php echo CHtml::image($this->resourceUrl('images_v2/about-us.png', 's3'), ''); ?>
                </div>
            </div>
        </div>
