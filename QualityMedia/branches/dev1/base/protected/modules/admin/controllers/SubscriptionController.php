        ...
        if($clientId) {
            ...
            $model->setAttributes(
                array(
                    ...
                    'phone'        => $client->billingInfo->phone,
                    'lastName'     => $client->billingInfo->lastName,
                    'address1'     => $client->billingInfo->address1,
                    'address2'     => $client->billingInfo->address2,
                    'city'         => $client->billingInfo->city,
                    'state'        => $client->billingInfo->state,
                    'zip'          => $client->billingInfo->zipCode,
                    'email'        => $client->email,
                    'clientId'     => $clientId
                )
            );
