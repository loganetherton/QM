...
$controllersConnection = array(
    ...
    'daemon'=>'Daemons Management',
    'task'=>'Daemons Management',
    'daemonCombinedLog'=>'Daemons Management',
);
...
$menuItems = array(
    ...
    'Daemons Management' => array('label'=>'Daemons Management', 'url'=>array('daemon/index'), 'icon'=>'icon3-wrench', array('class'=>'clearfix')),
);

//@Todo find a smartest way
if(strstr(Yii::app()->request->url, '/admin/client/createSubscription')) {
    $menuItems['Clients']['itemOptions'] = array('class'=>'active');
} else {
