...
$menuItems = array(
    ...
    'Settings' => array('label'=>'My Settings', 'url'=>array('settings/update'), 'icon'=>'icon3-user', 'linkOptions'=>array('class'=>'clearfix')),
);

if(Yii::app()->getUser()->isSenior()) {
    $menuItems['AM History'] = array('label'=>'AM History', 'url'=>array('juniorAmActivity/index'), 'icon'=>'icon3-user', 'linkOptions'=>array('class'=>'clearfix'));
}
