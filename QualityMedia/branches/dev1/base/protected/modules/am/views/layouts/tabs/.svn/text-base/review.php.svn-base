...
$items = array(
    ...
    'overdue'         => array('icon'=>'icon3-pencil', 'label'=>'Overdue Reviews', 'url'=>array('review/index', 'tab'=>'overdue')),
    'inactive'        => array('icon'=>'icon3-pencil', 'label'=>'Inactive Reviews', 'url'=>array('review/index', 'tab'=>'inactive')),
