...
foreach ($savedReports as $savedReport) {
    $dropdownReport['items'][] = array('label' => $savedReport->subject,
                                       'url'   => $this->createUrl('emailReport/saved/emailReportId/' . $savedReport->id));
}
...
<div class='lst-table e-report gran-data child-content well' style='margin-bottom: 0px; position: relative; min-height: 500px;'>
    ...
    <?php
        ...
        $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
            'method' => 'post',
            'action' => $this->createUrl('emailReportFakeData/saved' . $emailReportIdUrl . $createdUrl),
    ...
    <div class="container-padding post-hd middle-section" style='line-height: 40px; font-size: 1.2em; padding-top: 0.2em; '>
        <div class="span2 ilabel" style='padding: 5px; padding-left: 2%; border-right: 1px solid rgb(239, 239, 239); box-shadow: 0px 0px 1px rgb(239, 239, 239);'><?php echo $reportLabelBar; ?></div>
        ...
        <div class='row-fluid e-report form-horizontal' style='color: rgb(128, 128, 128)'>
            <div class='row-fluid span12'>
                <div class="control-group emailVerticalAlign">
                    ...
                    <div class="controls">
                        <?php
                        echo CHtml::activeTextField($model, 'fromAddress', array('class' => 'span12', 'value' => $accountManager->attributes['firstName'] . ' ' . $accountManager->attributes['lastName']));
                        ?>
                    </div>
                </div>
            </div>
