...
class Review extends ActiveRecord
{
    ...
    /**
     * @var integer Total recalculated Approval status
     */
    public $totalApprovalStatus;
    ...
    public function rules()
    {
        return array(
            ...
            array('starRating, userFriendCount, userReviewCount, flagReasonCategory, precontract', 'numerical', 'integerOnly'=>true),
    ...
    protected function afterFind()
    {
        ...
        //Approval status
        $this->totalApprovalStatus = $this->getApprovalStatus();
    ...
    public function getApprovalStatus()
    {
        ...
        if($this->hasPrivateMessages()) {
            ...
            $lastMessage = end($sortedMessages);
     ...
     */
    public function markAsFlagged($reason = '', $reasonCategory = null, $approved = false, $changed = false, $authorId = null)
    {
