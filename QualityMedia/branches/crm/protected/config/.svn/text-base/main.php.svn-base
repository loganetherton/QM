...
$config = array(
    ...
    'modules'=>array(
        ...
        'crm'=>array(
            ...
            'ccEncryptionKey'=>'21iw[[120x.x]1]#1d-1x1s01s112oas',
        ),
        'sales'=>array(
            'preload'=>array('bootstrap'),
            'components'=>array(
    ...
    'components'=>array(
        ...
        'urlManager'=>array(
            ...
            'rules'=>array(
                ...
                // CRM sign in / out
                'crm/login'  =>'crm/session/create',
                'crm/logout' =>'crm/session/delete',
                'crm'        =>'crm/contract/create',
        ...
        'clientScript'=>array(
            'scriptMap'=>array(
                ...
                'jquery.min.js'=>'https://qm-static.s3.amazonaws.com/js/jquery.min.js',
                'jquery.ba-bbq.js'=>'https://qm-static.s3.amazonaws.com/js/jquery.ba-bbq.js',
                'jquery.ba-bbq.min.js'=>'https://qm-static.s3.amazonaws.com/js/jquery.ba-bbq.js',
                ...
                'recurly-billing-form.min.js'=>'https://qm-static.s3.amazonaws.com/js/recurly-billing-form.min.js',
                'jquery.flot.min.js'=>'https://qm-static.s3.amazonaws.com/js/jquery.flot.min.js',
                'yelp-multiple-biz.js'=>'https://qm-static.s3.amazonaws.com/js/yelp-multiple-biz.js',
