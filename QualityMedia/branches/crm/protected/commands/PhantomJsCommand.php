...
//
//        echo $model->save() ? 'Saved MySQL' : 'Error saving MySQL';
//        echo "\n";
        
        /**
         * MongoDB code for saving historical data
         */
        $model = YelpAnalyticsStorage::model();
        var_dump($model);die;
        // Set the collection name to correspond to this client's businessId
        $model->setCollectionName($args[0]);
    ...
    public function actionUpdateInfo($args)
    {
        ...
        $update_params[] = CJSON::Encode($data);
