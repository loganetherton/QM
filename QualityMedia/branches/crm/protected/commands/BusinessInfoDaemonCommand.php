<?php
/**
 * Business info daemon command.
 *
 * @author Jakub Pospiech <jakub@qualitymedia.com>
 */
class BusinessInfoDaemonCommand extends DaemonCommand
{
    /**
     * @var string $pidFile PID file name.
     */
    public $pidFile = 'business-info.pid';
    ...
    public function actionIndex()
    {
        ...
        foreach($businesses as $business) {
            ...
            exec("{$path} readInfo {$business->id}", $result);
            $this->log(implode("\n", $result));
