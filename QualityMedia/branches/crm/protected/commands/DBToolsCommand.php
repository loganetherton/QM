...
class DbToolsCommand extends CConsoleCommand
{
     ...
     */
    public function actionRecalculateReviewsApprovalStatuses()
    {
        ...
        $reviews = Yii::app()->db->createCommand()->select()->from('reviews')->queryAll();
        $total = count($reviews);
        $counter = 0;
        ...
        foreach($reviews as $review) {
            ...
            $review->recalculateApprovalStatuses();
