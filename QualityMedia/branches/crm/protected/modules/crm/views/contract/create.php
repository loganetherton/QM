                            ...
                            <div class="controls">
                                <?php echo $form->dropDownList($model, 'accountStatus',
                                                               array(0 => 'New Account, Needs Call and Email',
                                                                     ...
                                                                     2 => 'Not Contacted',
                                                                     3 => 'Actively Servicing – One Way Communication',
                                                                     4 => 'Actively Servicing – Two Way Communication',
                                                                     5 => 'Unable to Login – Wrong Account Credentials or Not Provided',
                                                                     6 => 'In Limbo – Client May Proceed with Caution',
                                                                     7 => 'Saved – Lower Monthly Rate, PAY EXTRA ATTENTION',
                                                                     8 => 'Cancelled',
                                                                     9 => 'Collections (Unserviceable Due to Non-Payment)'),
                                                               array('class' => 'selectpicker span12')); ?>
                            </div>
                        </div>
                        <div class="control-group">
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                $this->widget('bootstrap.widgets.TbButton',array(
                    ...
                    'url' => Yii::app()->createUrl('crm/contract/create'),
                    'ajaxOptions' => array(
                        'update' => '#destination',
                    ),
                ));
                ...
                //    ));
                ?>
                <div id="snTemplate" style="display: none; margin-top: 10px;">
                    <fieldset>
...
<script type="text/javascript">
    ...
    {
        var $template = $('#snTemplate').clone();
        $template.removeAttr('id');
        $template.addClass('socialNetwork');
        $template.appendTo($('#snTemplate').parent()).show();
        var type = typeof info != 'undefined' ? info.type : $('select[name=snType]').val();
        var name = $('select[name=snType] > option[value=' + type + ']').text();
        ...
        if (type != <?php echo ContractSocialNetwork::TYPE_YELP ?>
            && type != <?php echo ContractSocialNetwork::TYPE_TWITTER ?>
            && type != <?php echo ContractSocialNetwork::TYPE_FOURSQUARE ?>
            && type != <?php echo ContractSocialNetwork::TYPE_TRIPADVISOR ?>) {
