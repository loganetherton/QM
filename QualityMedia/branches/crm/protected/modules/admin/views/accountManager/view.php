...
$linkedJuniorManagers = $model->findBySeniorManagerId($model->id);

$amStatuses = $model->getTypes();
?>
<div id="main-content">
    <div class="span12 row-fluid gran-data">
        ...
        <?php if($model->isSenior()): ?>
            <div class="row-fluid">
                <div class="span6">
                    <h3>Linked Junior Am's</h3>
                    <?php
                     $this->widget('bootstrap.widgets.TbGridView', array(
                        ...
                        'columns'=>array(
                            ...
                            array(
                                'name'=>'enabled',
                                'type'=>'raw',
                                'value'=>'CHtml::link("Remove Link", array("ajaxUnlinkAccountManager", "id"=>$data->id), array("class"=>"unlinkAm"));',
                            ),
                        ),
                    ));
                    ?>
