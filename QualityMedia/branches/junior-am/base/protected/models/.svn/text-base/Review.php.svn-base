...
class Review extends ActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('starRating, userFriendCount, userReviewCount, flagReasonCategory', 'numerical', 'integerOnly'=>true),
     ...
     */
    public function markAsFlagged($reason = '', $reasonCategory = null, $approved = false, $changed = false)
    {
     ...
     * @return boolean Whether the saving suceeded
     */
    public function answerWithPublicComment($comment, $author, $approved = false)
    {
        $transaction = $this->getDbConnection()->beginTransaction();
