 ...
 * {@link http://www.yiiframework.com/wiki/314/cgridview-use-special-variable-data-in-the-htmloptions-of-a-column-i-e-evaluate-htmloptions-attribute/}
 */
class ClientDataColumn extends CDataColumn
{
    /**
