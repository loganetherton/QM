...
(function( $ ){
    ...
    $.fn.videoUI = function( options ) {  
        ...
        if(settings.progressMedia){
            $('.'+controllerClass).append('<div class="progress" style="cursor:pointer"><div role="progressbar" class="progress-bar progressBar" style="width: 0%;" /><div role="progressbar" class="progress-bar bufferBar" style="width: 0%;opacity:0.5"/></div>');     
        ...
        if (settings.playMedia){
            $('.'+controllerClass).append('<a href="#" class="playMedia"><i class="glyphicon glyphicon-play icon-white"></i></a>');                        
        ...
        if (settings.volumeMedia){
            ...
            var on='';
            var html = '<i class="mute glyphicon glyphglyphicon-volume-up icon-white"></i><ul class="volumeMedia unstyled">';
            for(i=0;i<10;i++){
        ...
        if (settings.fullscreenMedia){
            $('.'+controllerClass).append('<i class="fullscreen glyphicon glyphicon-fullscreen icon-white"></i>');
