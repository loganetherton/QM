<?php
/**
 * Account Manager account command tool.
 *
 * @author Jakub Pospiech <jakub@qualitymedia.com>
 */
class AccountManagerCommand extends CConsoleCommand
{
    /**
    ...
    {
        // Deprecated message
        $this->usageError('This command is deprecated. Please use admin dashboard instead');
