...
$this->renderPartial('/layouts/tabs/client', array('active' => 'manage', 'manage' => true, 'id' => $data->id));

$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    'method' => 'post',
    'action' => $this->createUrl('manage/update', array('id' => $data->id)),
));
...
?>
    ...
    foreach ($additional_fields as $field => $label) {
        ...
        elseif ($field == 'smoking') {
            ...
            echo $data->info['basic_info']['additional_info'][$field] ? 'Yes' : ($data->info['basic_info']['additional_info'][$field] === false ? 'No' : '<span style="font-style: italic;">Not set</span>');
        }
                    ...
                    elseif ($field == 'smoking') {
                        ...
                        echo '
                                <div>', $label, ':<br />
                                    ...
                                    <input type="radio" name="BizInfo[info][basic_info][additional_info][', $field, ']"', $val === false ? ' checked' : '', ' value="0" /> No
                                </div>';
                    }
                }
