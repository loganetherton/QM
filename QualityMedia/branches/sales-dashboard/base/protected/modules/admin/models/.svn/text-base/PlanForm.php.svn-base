...
class PlanForm extends CFormModel
{
    ...
    {
        return array(
            array('businessName, firstName, lastName, email, cardNumber, securityCode, expirationMonth, expirationDay, salesmanId, amount, setupFee, addons, clientId, startDate', 'safe'),
        );
    }
